...
//import edu.boun.edgecloudsim.applications.sample_app5.VehicularScenarioFactory;
...
public class VehicularMainApp {
	...
	public static void main(String[] args) {
		...
		if (args.length == 5){
			...
			configFile = "scripts/sample_DRL/config/" + configName + "_config.properties";
			applicationsFile = "scripts/sample_DRL/config/applications.xml";
			edgeDevicesFile = "scripts/sample_DRL/config/edge_devices.xml";
